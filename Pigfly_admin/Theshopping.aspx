<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Theshopping.aspx.cs" Inherits="Pigfly_admin.Theshopping" %>
...
<div class="margin clearfix">
 ...
 <em class="type"></em>
	  <asp:Repeater ID="Getdetails" runat="server">
	 <ItemTemplate>
  <div class="shop_logo"><img src="images/detailnoimg.png" /></div>
   <ul class="shop_content clearfix">
    <li class="shop_name"><label class="label_name">项目名称：</label><span class="info"><%#Eval("Thename") %></span> 
    <div class="Authenticate"><i class="icon-yxrz"></i><i class="icon-yhk"></i><i class="icon-sjrz"></i><i class="icon-grxx"></i></div></li>
    <li><label class="label_name">引资类型：</label><span class="info"><%#Eval("Thecontent") %></span></li>
    <li><label class="label_name">店铺分类：</label><span class="info">服饰</span></li>
    <li><label class="label_name">申请时间：</label><span class="info"><%#Eval("Thetime") %></span></li>
    <li><label class="label_name">状&nbsp;&nbsp;&nbsp;&nbsp;态：</label><span class="info"><%#Eval("Thestate") %></span></li>
    <li><label class="label_name">申请人姓名：</label><span class="info"><%#Eval("username") %></span></li>
    <li><label class="label_name">移动电话：</label><span class="info"><%#Eval("uphone") %></span></li>
    <li><label class="label_name">电子邮箱：</label><span class="info"><%#Eval("uemail") %></span></li>
 ...
 <div class="Store_Introduction">
  <div class="title_name">详细介绍</div>
   <div class="info">
  <%#Eval("TheProjectContent") %>
   </div>
 </div>
		 </ItemTemplate>
    </asp:Repeater>
...
<%--				<button onclick="through_save('this','123');" class="btn btn-primary radius" type="submit">通  过</button>--%>
     <asp:Button ID="PassBtn" runat="server" CssClass="btn btn-primary radius" Text="通过" OnClick="PassBtn_Click"/>
	 <asp:Button ID="RefuseBtn" runat="server" CssClass="btn btn-danger  btn-warning" Text="拒绝" OnClick="RefuseBtn_Click"/>
