<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user-list.aspx.cs" Inherits="Pigfly_admin.user_list" %>
...
<div class="page-content clearfix">
    ...
    <div class="search_style">
      ...
      <ul class="search_content clearfix">
       <li><label class="l_f">会员名称</label><input name="" type="text"  class="text_add" placeholder="输入会员名称、电话、邮箱"  style=" width:400px" id="txtName" runat="server"/></li>
       <li><label class="l_f">添加时间</label><input class="inline laydate-icon" id="start" style=" margin-left:10px;" runat="server"/></li>
       <li style="width:90px;">  <asp:Button ID="btnSearch"  runat="server"  CssClass="btn btn-success" Text="查询"  OnClick="btnSearch_Click"/></li>
      </ul>
    </div>
     <!---->
	...
	<tbody>
        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
          ...
          <td><%#Eval("Uid") %></td>
          <td><%#Eval("username") %></td>
          <td><%#Convert.ToInt32( Eval("usex"))==1?"男":"女" %></td>
          <td><%#Eval("uphone") %></td>
          <td><%#Eval("uemail") %></td>
          <td class="text-l"><%#Eval("uaddress") %></td>
          <td><%#Eval("udatetime") %></td>
          <td>  <asp:Image ID="Image1" runat="server"  ImageUrl='<%#Eval("uimg") %>'  Height="50px" Width="50px"/>  </td>
            <td><%# GetSate(Convert.ToInt32( Eval("ustate"))) %> </td>
          <%--<td class="td-status"><%# GetSate(Convert.ToInt32( Eval("ustate"))) %></td>--%>
          <td class="td-manage">
          ...
          <a title="编辑" onclick="member_edit('550')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a> 
            <asp:LinkButton ID="DeleteLinkButton" runat="server" class="btn btn-xs btn-warning" CommandName="Delete" CommandArgument='<%#Eval("Uid") %>'><i class="fa fa-trash  bigger-120">删除</i></asp:LinkButton>
          </td>
		</tr>
