<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shopping_detailed.aspx.cs" Inherits="Pigfly_admin.shopping_detailed" %>
 ...
 <em class="type"></em>
  ...
  <div class="shop_logo"><img src="images/detailnoimg.png" /></div>
   <ul class="shop_content clearfix">
    <li class="shop_name"><label class="label_name">公司名称：</label><span class="info"><%#Eval("investname") %></span> 
    <div class="Authenticate"><i class="icon-yxrz"></i><i class="icon-yhk"></i><i class="icon-sjrz"></i><i class="icon-grxx"></i></div></li>
    <li><label class="label_name">投资类型：</label><span class="info"><%#Eval("investcontent") %></span></li>
    <li><label class="label_name">店铺分类：</label><span class="info">服饰</span></li>
    <li><label class="label_name">申请时间：</label><span class="info"><%#Eval("investtime") %></span></li>
    <li><label class="label_name">状&nbsp;&nbsp;&nbsp;&nbsp;态：</label><span class="info"><%#Eval("investstate") %></span></li>
