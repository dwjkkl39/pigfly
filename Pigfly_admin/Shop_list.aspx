<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shop_list.aspx.cs" Inherits="Pigfly_admin.Shop_list" %>
                ...
                <div class="Ads_list">
                    <div class="search_style">
                        ...
                        <ul class="search_content clearfix">
                            <li>
                                <label class="l_f">公司名称</label><input name="" type="text" class="text_add" placeholder="公司名称" style="width: 150px" runat="server" id="Txtinvestname"></li>
                            <li>
                    ...
                    <div class="border clearfix">
                        ...
                        <asp:Repeater ID="Repeater2" runat="server">
                            <ItemTemplate>
                                <span class="r_f">共：<b><%#Eval("investid") %></b>家</span>
                            </ItemTemplate>
                        </asp:Repeater>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample-table">
                            <thead>
                                <tr>
                                    ...
                                    <th width="80px">投资项目Id</th>
                                    <th width="180">公司名称</th>
                                    <th width="120px">投资资金</th>
                                    <th width="120px">意向投资引资地址</th>
                                    <th width="">发布时间</th>
                                    <th width="150px">投资描述</th>
                                    <th width="100px">投资类型</th>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%#Eval("investaddress") %></td>
                                            <td><%#Eval("investtime") %></td>
                                            <td class="displayPart" displaylength="60"><%#Eval("investProjectContent") %></td>
                                            ...
                                            <td class="td-manage">
                                                <%--<a title="删除"  href="javascript:;" onclick="member_del(this,'1')" class="btn btn-xs btn-danger"><i class="fa fa-trash  bigger-120"></i></a>--%>
                                                        <asp:LinkButton ID="IdDelete" runat="server"   class="btn btn-xs btn-danger" CommandName="Delete" CommandArgument='<%#Eval("investid")%>'><i class="fa fa-trash  bigger-120"></i></asp:LinkButton>
