<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_info.aspx.cs" Inherits="Pigfly_admin.admin_info" %>
   ...
   <div class="admin_modify_style" id="Personal">
     <div class="type_title">管理员信息 </div>
        ...
        <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">用户名： </label>
          <div class="col-sm-9">
              <input type="text" name="用户名" id="IdmidName" value="张小泉" class="col-xs-7 text_info"  runat="server"/>
          ...
          <div class="col-sm-9">
          <input type="text" name="用户名" id="IdSex" value="张小泉" class="col-xs-7 text_info"  runat="server"/>
            <div class="add_sex">
          ...
          <div class="col-sm-9"><input type="text" name="年龄" id="IdAge" value="24" class="col-xs-7 text_info"  runat="server"/></div>
          </div>
          <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">移动电话： </label>
          <div class="col-sm-9"><input type="text" name="移动电话" id="Idmphone" value="13567878908" class="col-xs-7 text_info"  runat="server"/></div>
          </div>
          <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">电子邮箱： </label>
          <div class="col-sm-9"><input type="text" name="电子邮箱" id="Idmailbox" value="567890@qq.com" class="col-xs-7 text_info" runat="server"/></div>
          </div>
          ...
          <div class="col-sm-9" ><input type="text" name="电子邮箱" id="IdAddtime" value="567890@qq.com" class="col-xs-7 text_info" disabled="disabled"  runat="server"/></div>
          </div>
           <div class="Button_operation clearfix"> 
				<%--<button onclick="modify();" class="btn btn-danger radius" type="submit">修改信息</button>--%>
               <asp:Button ID="UPdate" OnClientClick="modify();"  class="btn btn-danger radius" type="button" runat="server" Text="修改信息" OnClick="UPdate_Click"/>
               <asp:Button ID="UPdateEdit"  class="btn btn-danger radius" type="button" runat="server" Text="保存修改" OnClick="UPdateEdit_Click" Visible="False"/>
...
<script>
 ...
 //按钮点击事件
    function modify() {
        $("#IdmidName").removeClass("disabled");
